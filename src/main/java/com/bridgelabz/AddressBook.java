...
public class AddressBook {
    final String FILE_PATH="D:\\IntelliJ IDEA\\Address_Book_Service\\src\\main\\resources\\Contact.txt";
    final String FILE_PATH1="D:\\IntelliJ IDEA\\Address_Book_Service\\src\\main\\resources\\contact.CSV";
    final String FILE_PATH3="D:\\IntelliJ IDEA\\Address_Book_Service\\src\\main\\resources\\Contact.json";
    ...
    public void editContact () {
        for (Contacts contactlist : list) {
            System.out.println("Enter the First Name : ");
            String firstName = sc.next();
            if (firstName.equalsIgnoreCase(contactlist.getFirstname())) {
                System.out.println("Match Found--------!!!!");
                System.out.println("-----------------------");
                System.out.println("Enter the First Name :");
                contacts.setFirstname(sc.next());
...
//            FileWriter fw=new FileWriter(FILE_PATH);
            FileWriter fw=new FileWriter(FILE_PATH1);
//            FileWriter fw=new FileWriter(FILE_PATH1);
...
//            FileReader fr = new FileReader(FILE_PATH);
            FileReader fr = new FileReader(FILE_PATH1);
//            FileReader fr = new FileReader(FILE_PATH2);
            int i;
            while ((i = fr.read()) != -1)
